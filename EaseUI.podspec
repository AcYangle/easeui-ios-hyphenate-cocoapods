Pod::Spec.new do |spec|
  ...
  spec.homepage     = 'https://github.com/AcYangle/easeui-ios-hyphenate-cocoapods'
  spec.author       = {'EaseMob Inc.' => 'admin@easemob.com'}
  spec.source       =  {:git => 'https://github.com/AcYangle/easeui-ios-hyphenate-cocoapods.git', :tag => spec.version.to_s }
